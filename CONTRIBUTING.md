...
to view it. CI uploads the same build as a `documentation` artifact. Documentation
...
- Choose repository visibility and documentation hosting before registration.
